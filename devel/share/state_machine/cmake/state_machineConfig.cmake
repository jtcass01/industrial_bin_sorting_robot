...
if("TRUE" STREQUAL "TRUE")
  set(state_machine_SOURCE_PREFIX /home/durzo/programming/industrial_bin_sorting_robot/src/state_machine)
  set(state_machine_DEVEL_PREFIX /home/durzo/programming/industrial_bin_sorting_robot/devel)
  ...
  set(state_machine_INSTALL_PREFIX /home/durzo/programming/industrial_bin_sorting_robot/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'durzo <durzo@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'state_machine' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/durzo/programming/industrial_bin_sorting_robot/src/state_machine/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/durzo/programming/industrial_bin_sorting_robot/devel/lib;/home/durzo/programming/industrial_bin_sorting_robot/devel/lib;/opt/ros/melodic/lib)
