...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'state_machine' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/durzo/programming/industrial_bin_sorting_robot/install/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/durzo/programming/industrial_bin_sorting_robot/install/lib;/home/durzo/programming/industrial_bin_sorting_robot/devel/lib;/opt/ros/melodic/lib)
